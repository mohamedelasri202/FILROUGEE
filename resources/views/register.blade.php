    ...
    <main class="container mx-auto py-8 px-4 max-w-3xl">
        ...
        <form class="space-y-6" action="{{route('register.post') }}" method= "POST">
            ...
            <div>
                ...
                <select type="role" id="role" name="role" placeholder="role" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500">
