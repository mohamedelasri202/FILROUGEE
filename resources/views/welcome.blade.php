        ...
        <div class="container mx-auto px-4">
            ...
            <div id="services">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <!-- Service Category 1 -->
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                        <img src="/placeholder.svg?height=200&width=300" alt="Home Delivery" class="w-full h-48 object-cover">
                        <div class="p-4">
                    ...
                    <!-- Service Category 2 -->
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                        <img src="/placeholder.svg?height=200&width=300" alt="Home Cleaning" class="w-full h-48 object-cover">
                        <div class="p-4">
                    ...
                    <!-- Service Category 3 -->
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                        <img src="/placeholder.svg?height=200&width=300" alt="Appliance Repair" class="w-full h-48 object-cover">
                        <div class="p-4">
                    ...
                    <!-- Service Category 4 -->
                    <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                        <img src="/placeholder.svg?height=200&width=300" alt="Home Painting" class="w-full h-48 object-cover">
                        <div class="p-4">
